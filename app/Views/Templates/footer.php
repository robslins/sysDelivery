...
<footer class="bg-dark text-center text-white">
    ...
    <div class="container p-4 pb-0">
        ...
        <section class="mb-4">
            ...
            <a class="btn btn-outline-light btn-floating m-1 btn-circle " href="#" role="button"><i
    ...
    <div class="text-center p-3" style="background-color: rgba(0, 0, 0, 0.2);">
        © 2023 Copyright: Todos os direitos reservado a
        <a class="text-white" href="#">Robson Lins Franco de Oliveira</a>
    </div>
    <!-- Copyright -->
</footer>
<!-- Fecha footer -->